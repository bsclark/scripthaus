...
repo --name="cloudstack" --baseurl=http://<server addr>/cloudstack/
...
cat > /etc/yum.repos.d/cloudstack.repo << REPO_CLOUDSTACK_EOF
[cloudstack]
name=cloudstack
baseurl=http://<server addr>/cloudstack/
enabled=1
gpgcheck=0
REPO_CLOUDSTACK_EOF
